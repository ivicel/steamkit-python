...
# source: steam/protobufs/steammessages_parental_steamclient.proto
...
ParentalApp = _reflection.GeneratedProtocolMessageType('ParentalApp', (_message.Message,), dict(
  ...
  __module__ = 'steam.protobufs.steammessages_parental_steamclient_pb2'
