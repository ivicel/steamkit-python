...
# source: steam/protobufs/steammessages_twofactor_steamclient.proto
...
CTwoFactor_Status_Request = _reflection.GeneratedProtocolMessageType('CTwoFactor_Status_Request', (_message.Message,), dict(
  ...
  __module__ = 'steam.protobufs.steammessages_twofactor_steamclient_pb2'
