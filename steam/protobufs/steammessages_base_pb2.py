...
# source: steam/protobufs/steammessages_base.proto
...
CMsgProtoBufHeader = _reflection.GeneratedProtocolMessageType('CMsgProtoBufHeader', (_message.Message,), dict(
  ...
  __module__ = 'steam.protobufs.steammessages_base_pb2'
