...
# source: steam/protobufs/stream.proto
...
CDiscoveryPingRequest = _reflection.GeneratedProtocolMessageType('CDiscoveryPingRequest', (_message.Message,), dict(
  ...
  __module__ = 'steam.protobufs.stream_pb2'
