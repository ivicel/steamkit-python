...
# source: steam/protobufs/steammessages_secrets_steamclient.proto
...
CKeyEscrow_Request = _reflection.GeneratedProtocolMessageType('CKeyEscrow_Request', (_message.Message,), dict(
  ...
  __module__ = 'steam.protobufs.steammessages_secrets_steamclient_pb2'
