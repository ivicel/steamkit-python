...
# source: steam/protobufs/steammessages_clientserver_friends.proto
...
CMsgClientFriendMsg = _reflection.GeneratedProtocolMessageType('CMsgClientFriendMsg', (_message.Message,), dict(
  ...
  __module__ = 'steam.protobufs.steammessages_clientserver_friends_pb2'
