...
# source: steam/protobufs/steammessages_qms_steamclient.proto
...
GameSearchParam = _reflection.GeneratedProtocolMessageType('GameSearchParam', (_message.Message,), dict(
  ...
  __module__ = 'steam.protobufs.steammessages_qms_steamclient_pb2'
