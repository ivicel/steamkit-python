...
# source: steam/protobufs/steammessages_clientserver_login.proto
...
CMsgClientHeartBeat = _reflection.GeneratedProtocolMessageType('CMsgClientHeartBeat', (_message.Message,), dict(
  ...
  __module__ = 'steam.protobufs.steammessages_clientserver_login_pb2'
