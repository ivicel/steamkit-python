...
# source: steam/protobufs/steammessages_gameservers_steamclient.proto
...
CGameServers_GetServerList_Request = _reflection.GeneratedProtocolMessageType('CGameServers_GetServerList_Request', (_message.Message,), dict(
  ...
  __module__ = 'steam.protobufs.steammessages_gameservers_steamclient_pb2'
